...
def run_coteaching_cv(dataset, n_splits=5, batch_size=128, num_classes=10,
...
def run_coteaching_experiments():
    """
    ...
    for file in all_datasets.keys():
        ...
        results, models = run_coteaching_cv(
            dataset=train_df, n_splits=2, batch_size=128, num_classes=3,
